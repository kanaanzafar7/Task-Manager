...
class TaskDetailsRouter: NSObject, TaskDetailsRoutingLogic, TaskDetailsDataPassing
{
    ...
    //func navigateToSomewhere(source: TaskDetailsViewController, destination: SomewhereViewController)
    //{
    ...
    //func passDataToSomewhere(source: TaskDetailsDataStore, destination: inout SomewhereDataStore)
    //{
